        ...
        child: Column(children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.work_outline, size: 12, color: Color(0xFF1B96FF)),
                      SizedBox(width: 4),
                      Text('작업', style: TextStyle(color: Color(0xFF1B96FF), fontSize: 10, fontWeight: FontWeight.w600)),
                    ]),
                  ),
                ),
              ]),
          ...
          Container(
            ...
            child: Row(children: [
              ...
              _tabBtn('작업', Icons.work_outline, _tab == 3, () => setState(() => _tab = 3)),
            ]),
          ),
          // 탭 내용
          Expanded(
