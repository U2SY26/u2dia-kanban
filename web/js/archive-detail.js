...
const ArchiveDetail = {
  ...
  _renderFull(container) {
    ...
    wrap.innerHTML = `
      ...
      <div class="archive-filter-bar">
        ...
        <button class="archive-filter-btn" data-f="artifact" onclick="ArchiveDetail.setFilter('artifact')">산출물</button>
  ...
  _renderArtifactCard(e) {
    ...
    h += '<div class="git-card-top">';
    h += '<span class="git-artifact-type">' + Utils.esc(e.artifactType || '') + (e.language ? ' (' + Utils.esc(e.language) + ')' : '') + '</span>';
