...
const AgentOffice = {
  ...
  async open(teamId) {
    ...
    hdr.innerHTML = '<div style="display:flex;align-items:center;gap:8px">' + Utils.icon('users', 16, 1.75) + '<span style="color:#e6edf3;font-size:14px;font-weight:700">' + Utils.esc(team.name || '') + '</span><span style="color:#8b949e;font-size:11px">' + done + '/' + tickets.length + ' done</span></div><button onclick="AgentOffice.close()" style="background:none;border:none;color:#8b949e;font-size:20px;cursor:pointer;padding:4px 8px">&times;</button>';
