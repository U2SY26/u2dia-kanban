...
- **긴 작업 위임 (모바일→데스크톱)** → cli_enqueue 로 개발 PC에 큐 등록 (auto_approve=true 로 즉시 실행).
  완료 확인은 cli_status. 예: "LINKO 에서 npm test 돌려줘" → cli_enqueue(prompt="npm test", project_path="~/github/LINKO", auto_approve=true)
...
SUPERVISOR_MODELS = [
    # ── Ollama 로컬 (상주 Supervisor, 무료, 빠름) ──
    {"id": "ollama:qwen3.5:27b", "name": "Qwen 3.5 27B", "provider": "ollama", "description": "로컬 GPU, 도구호출 지원, 상주 추천"},
    {"id": "ollama:gemma4:26b", "name": "Gemma 4 26B", "provider": "ollama", "description": "로컬 GPU, Google 최신 모델"},
    {"id": "ollama:gemma4:31b", "name": "Gemma 4 31B", "provider": "ollama", "description": "로컬 GPU, Google 대형"},
    {"id": "ollama:gemma3:27b", "name": "Gemma 3 27B", "provider": "ollama", "description": "로컬 GPU, 안정"},
...
def _get_known_projects():
    ...
    # 기본값 (Ubuntu 경로)
    defaults = [
        ("Hexacotest", "~/github/Hexacotest"),
        ("PMI-AIP", "~/github/PMI-AIP"),
        ("LEEPARK", "~/github/LEEPARK"),
        ("NC_PROGRAM", "~/github/NC_PROGRAM"),
        ("PMI-LINK-GLOBAL", "~/github/PMI-LINK-GLOBAL"),
        ("Bible", "~/github/Bible"),
        ("U2DIA_HOME", "~/github/U2DIA_HOME"),
        ("U2DIA_METAVERS", "~/github/U2DIA_METAVERS"),
        ("life", "~/github/life"),
        ("planner", "~/github/planner"),
        ("LINKO", "~/github/LINKO"),
        ("cupang_api", "~/github/cupang_api"),
        ("U2DIA-KANBAN-BOARD", "~/u2dia-kanban"),
    ]
...
_COMPETITION_DIRS_DEFAULT = [
    {"path": "~/github/kaggle-measuring-agi", "project_group": "kaggle-measuring-agi", "keywords": ["measuring-agi", "measuring agi"]},
    {"path": "~/github/nemotron-reasoning-challenge", "project_group": "nemotron-reasoning-challenge", "keywords": ["nemotron", "sft", "grpo"]},
    {"path": "~/github/gemma4-particle-edu", "project_group": "Gemma4 Particle Edu", "keywords": ["gemma4", "gemma 4", "particle", "hackathon"]},
    {"path": "~/github/adaptionlabs", "project_group": "adaptionlabs", "keywords": ["adaptionlabs", "adaption labs", "adaption-labs"]},
]
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "project_path": {"type": "string", "description": "실행할 프로젝트의 절대 경로 (예: ~/github/LINKO)"},
